...
sellAllBuild.addEventListener("click", function(){
    ...
    function worthCheck(){
        ...
        if (netWorth >= 1000 && netWorth < 1000000) {
            ...
            worthElement.textContent = (netWorth / 1000000000000000).toFixed(1) + " Kuatrilyon₺";
        }
        else{
        ...
        if (localStorage.getItem("lastWorth") > netWorth) {
            document.getElementById("worth").style.color = "#FF0000";
        localStorage.setItem("lastWorth", netWorth);

        }
        else{
            document.getElementById("worth").style.color = "#90EE90";
...
function checkMoney(){
    ...
    if (money >= 1000 && money < 1000000) {
        ...
        moneyText.textContent = (money / 1000000000000000).toFixed(1) + " Kuatrilyon₺";
    }
...
function beforePayout(){
    if (cafeOwn == 1 || buildOwn == 1 || compuOwn == 1 || brandOwn == 1 || carOwn == 1 || shopOwn == 1 || ecomOwn == 1 || smartOwn == 1 || fonOwn == 1|| stocksOwn == 1|| bankOwn == 1|| autoOwn == 1) {
        document.getElementById("beforePayout").style.display = "block";
        document.getElementById("beforePayout").textContent = 30-(day%30) + " gün sonra ödeme";
    }
}