...
function incomeCheck(){
    ...
    return money, taxDebit, cafeValue, buildBusValue
}
...
sellAllBuild.addEventListener("click", function(){
    ...
    function worthCheck(){
        ...
        if (buildOwn == 1) {
            netWorth += buildBusValue;
        }
        if (compuOwn == 1) {
            netWorth += compuBusValue;
        }
        if (brandOwn == 1) {
            netWorth += brandValue;
        }
