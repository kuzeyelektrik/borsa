...
teachNext.addEventListener("click", function(){
    if (teach == 0) {
        if (teachPart == 1) {
            ...
            teachDescription.textContent = "Sol üst köşede yer alan nakit, anlık olarak harcama ve yatırım yapabileceğin nakit paranı gösterir.";
        }
        else if (teachPart == 2) {
            teachHeader.textContent = "Yatırımlar Toplamı";
            teachDescription.textContent = "Nakitin hemen altında yer alan yatırımlar toplamı, tüm yatırımlarınızın toplam değerini gösterir.";
        }
        else if (teachPart == 3) {
